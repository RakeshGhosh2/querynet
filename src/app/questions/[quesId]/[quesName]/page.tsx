...
const Page = async ({ params }: { params: Promise<{ quesId: string; quesName: string }> }) => {
    ...
    const [question, answers, upvotes, downvotes, comments] = await Promise.all([
        databases.getDocument<Question>(db, questionCollection, quesId),
        databases.listDocuments<Answer>(db, answerCollection, [
    ...
    console.log("all clear in question qusid qusname->")
    return (
